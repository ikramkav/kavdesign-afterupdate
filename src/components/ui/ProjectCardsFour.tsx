...
const techStackData: TechItemProps[] = [
  {
    id: "t1",
    name: "CSS",
    icon: <img src="/images/projectcards/css.png" alt="CSS" className="w-[42px] h-[42px]" />,
    position: "top-[10%] left-[50%] -translate-x-1/2",
  },
  {
    id: "t2",
    name: "JS",
    icon: <img src="/images/projectcards/jslogo.png" alt="JavaScript" className="w-[42px] h-[42px]" />,
    position: "top-[25%] right-[15%]",
  },
  {
    id: "t3",
    name: "MySQL",
    icon: <img src="/images/projectcards/mysql.png" alt="MySQL" className="w-[42px] h-[42px]" />,
    position: "bottom-[30%] right-[10%]",
  },
  {
    id: "t4",
    name: "HTML",
    icon: <img src="/images/projectcards/html5.png" alt="HTML5" className="w-[42px] h-[42px]" />,
    position: "bottom-[10%] left-[50%] -translate-x-1/2",
  },
  {
    id: "t5",
    name: "Laravel",
    icon: <img src="/images/projectcards/Laravel.png" alt="Laravel" className="w-[42px] h-[42px]" />,
    position: "bottom-[25%] left-[15%]",
  },
  {
    id: "t6",
    name: "Stripe",
    icon: <img src="/images/projectcards/Stripe.png" alt="Stripe" className="w-[63px] h-[40px] aspect-[9/5]" />,
...
const projectsData = [
  {
    ...
    leftSectionData: [
      ...
      },
      {
        ...
        content: "With decades of experience, Chemco integrates advanced technology.",
      },
    ],
    resultsData: [
      {
...
// --- Main Component ---
export function ProjectCard({ leftSectionData, resultsData, index, totalCards }) {
...
//   const scale = useTransform(scrollYProgress, [0, 1], [2, 1])
  ...
  useEffect(() => {
    ...
    // Scale down and fade slightly as it stacks
    tl.to(card, {
  ...
  return (
    ...
    // ref={container}
     className="flex items-center justify-center min-h-screen">
      ...
      >
        <Image src="/images/projectcards/cardbg.png" alt="card background" fill className="object-cover" priority />
        ...
        >
          ...
          <motion.div className="lg:col-span-4 flex flex-col gap-6">
            {leftSectionData.map((item, index) => (
              <div key={item.id}>
                {item.type === "brand" && (
                  <motion.div
                    initial={{
                  ...
                  >
                    <div className="h-12 w-12 bg-white rounded-full flex items-center justify-center shadow-sm shrink-0">
                      <Image src="/images/projectcards/chemco.png" alt="sideshade" width={120} height={60} />
                    </div>
                    <div>
                      <div className="flex items-center gap-2">
                        <p className="text-black font-[Bw_Gradual_DEMO] text-[18px] font-medium">{item.title}</p>
                      </div>
                ...
                {item.type === "industry" && (
                  ...
                  >
                    <div className="">
                      <h3 className="text-[#000] text-center font-['Bw_Gradual_DEMO'] text-[18px] font-medium">
                        {item.title}
                      </h3>
                      <div className="flex">
                        <p className="text-[#1E2F40] text-start px-0 font-['Nunito_Sans'] text-[12px] font-normal leading-[14px]">
                          {item.content}
                        </p>
                        <div className="h-10 w-10 bg-blue-500/80 rounded-lg flex items-end justify-end shrink-0">
                          <Image src="/images/projectcards/medicplus.png" alt="sideshade" width={66} height={66} />
                        </div>
                      </div>
                    </div>
                  </motion.div>
            ...
            <div className="relative w-full h-full border rounded-[25px] bg-[linear-gradient(111deg,rgba(255,255,255,0.4)_-8.95%,rgba(255,255,255,0.01)_114%)] backdrop-blur-[50px] flex items-center justify-center overflow-hidden">
              ...
              >
                {techStackData.map((tech, index) => {
                  const angle = (360 / techStackData.length) * index
                  ...
                  return (
                    ...
                    >
                      {/* Counter rotation so icon stays straight */}
                      <motion.div
                        animate={{ rotate: -360 }}
                        transition={{
                          repeat: Number.POSITIVE_INFINITY,
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="72" height="72" viewBox="0 0 72 72" fill="none">
                    ...
                    <defs>
                      ...
                      >
                        ...
                        <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_1264_394" />
                        <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_1264_394" result="shape" />
                      </filter>
                      <linearGradient
          ...
          {/* --- RIGHT COLUMN --- */}
          <motion.div variants={rightColumn} className="lg:col-span-4 flex flex-col justify-start gap-8 pl-4">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 13 13" fill="none">
                      ...
                      <defs>
                        ...
                        >
                          ...
                          <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_1264_1079" />
                          <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_1264_1079" result="shape" />
                        </filter>
                        <radialGradient
